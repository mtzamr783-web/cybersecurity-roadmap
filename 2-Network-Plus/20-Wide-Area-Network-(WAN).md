...
<li><strong>NHRP (Next Hop Resolution Protocol):</strong> بروتوكول بيسمح للـ Spokes إنها "تسأل" عن بعض — كل Spoke بيسجّل عنوانه الحقيقي (Public IP) عند الـ Hub، ولما Spoke يحتاج يتواصل مع Spoke تاني مباشرة، بيستخدم NHRP يستفسر من الـ Hub عن عنوان الـ Spoke التاني الحقيقي عشان يقدر ينشئ النفق المؤقت المباشر بينهم.</li>
