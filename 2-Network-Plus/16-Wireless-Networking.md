...
| 5 | [طرق إرسال البيانات عبر الهوائي](#signal-transmission) | [طرق تعديل الإشارة](#modulation)<br>[نمط انتشار الموجات](#wave-propagation)<br>[تقنيات التوجيه وتعدد المنافذ (MIMO)](#mimo)<br>[طرق تعدد الوصول](#multiple-access)<br>[طرق البث](#broadcasting-methods)<br>[أنواع الاستقطاب](#polarization) |
| 6 | [أنواع الاتصال اللاسلكي](#connection-types) | [نقطة لنقطة، متعدد، بث](#connection-types-detail) |
| 7 | [طرق نقل البيانات](#transmission-methods) | [النطاق الضيق أحادي التردد](#narrowband)<br>[الطيف المنتشر](#spread-spectrum) |
| 8 | [طرق توصيل الأجهزة ببعضها (Topologies)](#wireless-topologies) | [Infrastructure Mode](#infrastructure-mode)<br>[Ad-Hoc Mode](#adhoc-mode)<br>[النمط الممتد Mesh](#mesh-mode)<br>[بنية نقاط الوصول](#ap-architecture)<br>[عملية الارتباط بنقطة الوصول](#association-process) |
| 9 | [أنواع الشبكات اللاسلكية حسب النطاق](#wireless-network-types) | [WPAN](#wpan)<br>[WLAN](#wlan)<br>[WMAN](#wman)<br>[WWAN](#wwan) |
| 10 | [خاصية التجوال (Roaming)](#roaming) | - |
| 11 | [إعداد الشبكة اللاسلكية](#ap-configuration) | [خطوات الإعداد الأساسية](#ap-basic-setup)<br>[إعداد DHCP وإدارة المستخدمين](#ap-dhcp-users) |
| 12 | [مشاكل الانقطاع والمعوقات المؤثرة](#wireless-interference) | [أسباب انقطاع الإشارة](#signal-loss-causes)<br>[القنوات المتداخلة وغير المتداخلة](#channel-overlap)<br>[عرض القناة وBand Steering](#channel-width) |
| 13 | [أمان الشبكة اللاسلكية](#wireless-security) | [هجمات شائعة تستهدف الشبكة](#wireless-attacks)<br>[إخفاء وتغيير SSID](#ssid-hiding)<br>[تحديد نطاق التغطية](#coverage-limiting)<br>[إنشاء الحسابات وكلمات المرور](#accounts-passwords)<br>[تفعيل RADIUS و AAA](#radius-aaa)<br>[مراقبة الشبكة](#wireless-monitoring)<br>[برامج الحماية على الأجهزة](#endpoint-protection)<br>[تصفية عناوين MAC](#mac-filtering)<br>[الشبكة الضيفية و Captive Portal](#guest-network) |
| 14 | [بروتوكولات تشفير الشبكة اللاسلكية](#encryption-protocols) | [WEP](#wep)<br>[WPA](#wpa)<br>[WPA2](#wpa2)<br>[WPA3](#wpa3)<br>[IPSec](#ipsec)<br>[جدول مقارنة](#encryption-comparison) |
...
<ul dir="rtl">
<li><strong>IEEE (Institute of Electrical and Electronics Engineers):</strong> المؤسسة المسؤولة عن وضع المعايير التقنية للشبكات اللاسلكية، وأشهر معيار وضعته هو عائلة معايير <strong>802.11</strong> اللي بتحدد كل تفاصيل عمل الشبكة اللاسلكية (السرعة، الترددات، طريقة التشفير...إلخ).</li>
<li><strong>Wi-Fi Alliance:</strong> منظمة غير حكومية مكونة من شركات مصنعة، مهمتها إنها تتأكد إن الأجهزة المختلفة اللي بتدعي دعم معيار معين (زي Wi-Fi 6) متوافقة فعليًا مع بعضها (Interoperability Certification)، وهي اللي بتمنح شهادة "Wi-Fi Certified" وهي اللي أطلقت مسميات "Wi-Fi 4/5/6/7" التسويقية بدل أرقام المعايير التقنية المعقدة.</li>
<li><strong>FCC (Federal Communications Commission):</strong> الهيئة الحكومية الأمريكية المسؤولة عن تنظيم استخدام الترددات اللاسلكية في الولايات المتحدة، بتحدد مين مسموح له يستخدم أي نطاق تردد وبأنهي قوة إرسال.</li>
<li><strong>ITU (International Telecommunication Union):</strong> منظمة دولية تابعة للأمم المتحدة، مسؤولة عن التنسيق العالمي لاستخدام الترددات بين الدول المختلفة عشان يتجنبوا التداخل بين الدول المتجاورة.</li>
</ul>
...
<table align="center">
<tr><th>المعيار</th><th>الاسم التسويقي</th><th>التردد</th><th>أقصى سرعة نظرية</th></tr>
...
<tr><td>802.11n</td><td>Wi-Fi 4</td><td>2.4/5 GHz</td><td>~600 Mbps (مع MIMO)</td></tr>
...
<tr><td>802.11be</td><td>Wi-Fi 7</td><td>2.4/5/6 GHz</td><td>~46 Gbps (نظريًا)</td></tr>
</table>
...
<h2 dir="rtl" align="right" id="signal-transmission">5️⃣ طرق إرسال البيانات عبر الهوائي</h2>
...
<p dir="rtl" align="right">
بما إن الهواء وسط مشترك بين كل الأجهزة اللي في نطاق نقطة الوصول (زي الـ Hub بالظبط من ناحية المبدأ، راجع Topic 15)، لازم يكون فيه آلية تحكم في مين يقدر يرسل وإمتى عشان نتجنب التصادم. الشبكات اللاسلكية بتستخدم بروتوكول <strong>CSMA/CA (Carrier Sense Multiple Access with Collision Avoidance)</strong>، وده مختلف عن CSMA/CD المستخدم في الشبكات السلكية القديمة (راجع Topic 9):
</p>
...
<h2 dir="rtl" align="right" id="connection-types">6️⃣ أنواع الاتصال اللاسلكي</h2>

<h3 dir="rtl" align="right" id="connection-types-detail">🔹 نقطة لنقطة، متعدد، بث</h3>
...
<li><strong>Point-to-Multipoint (P2MP):</strong> جهاز مركزي واحد (زي نقطة الوصول) بيتصل بيه عدة أجهزة في نفس الوقت، وهو النمط الأكتر شيوعًا في شبكات الـ Wi-Fi العادية (Infrastructure Mode).</li>
...
<h2 dir="rtl" align="right" id="transmission-methods">7️⃣ طرق نقل البيانات (نطاق الترددات المستخدم)</h2>

<h3 dir="rtl" align="right" id="narrowband">🔹 النطاق الضيق أحادي التردد (Narrowband)</h3>

<p dir="rtl" align="right">
تقنية <strong>Narrowband</strong> بترسل كل البيانات على تردد واحد ثابت وضيق النطاق. ميزتها الأساسية إنها بسيطة وبتستخدم عرض ترددي صغير جدًا، لكن عيبها الكبير إنها حساسة جدًا للتداخل (Interference) والتشويش، لأنه لو حصل تشويش بالظبط على التردد ده، الاتصال كله بيتعطل من غير أي بديل. بتستخدم في تطبيقات محدودة زي بعض أجهزة الراديو القديمة وأنظمة التحكم عن بعد البسيطة.
</p>
...
<h2 dir="rtl" align="right" id="wireless-topologies">8️⃣ طرق توصيل الأجهزة ببعضها (Wireless Topologies)</h2>

<h3 dir="rtl" align="right" id="infrastructure-mode">🔹 Infrastructure Mode (اتصال عبر نقطة وصول مركزية)</h3>

<p dir="rtl" align="right">
الوضع الأكتر شيوعًا في الشبكات اللاسلكية، وفيه كل الأجهزة بتتصل بجهاز مركزي واحد وهو <strong>Access Point (AP)</strong>، وأي تواصل بين جهازين لازم يمر عن طريق نقطة الوصول دي أولاً حتى لو الجهازين قريبين من بعض فيزيائيًا. الوضع ده بيسهل الإدارة والأمان المركزي، وهو الأساس اللي بتشتغل عليه شبكات المنازل والشركات.
</p>
...
<h2 dir="rtl" align="right" id="wireless-network-types">9️⃣ أنواع الشبكات اللاسلكية حسب النطاق الجغرافي</h2>
...
<h2 dir="rtl" align="right" id="roaming">🔟 خاصية التجوال (Roaming)</h2>
...
<h2 dir="rtl" align="right" id="ap-configuration">1️⃣1️⃣ إعداد الشبكة اللاسلكية (AP Configuration)</h2>
...
<h2 dir="rtl" align="right" id="wireless-interference">1️⃣2️⃣ مشاكل الانقطاع والمعوقات المؤثرة</h2>
...
<h2 dir="rtl" align="right" id="wireless-security">1️⃣3️⃣ أمان الشبكة اللاسلكية</h2>
...
<h2 dir="rtl" align="right" id="encryption-protocols">1️⃣4️⃣ بروتوكولات تشفير الشبكة اللاسلكية</h2>
...
<tr><td><strong>المؤسسات الأساسية</strong></td><td>IEEE (المعايير) - Wi-Fi Alliance (التوافق) - FCC (تنظيم أمريكي) - ITU (تنسيق عالمي)</td></tr>
